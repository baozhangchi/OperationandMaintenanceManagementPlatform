...
public class MonitorHub : Hub
{
    ...
    public Task Callback(string taskId, JsonElement state)
    {
    ...
    public override Task OnDisconnectedAsync(Exception? exception)
    {
        ...
        if (_monitorState.Clients != null)
        {
            return _monitorState.Clients.All.SendAsync(nameof(IClientHandler.ClientsUpdated), _monitorState.ToList());
        }
