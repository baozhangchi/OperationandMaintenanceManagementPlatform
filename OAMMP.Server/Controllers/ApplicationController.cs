...
public class ApplicationController : ControllerBase
{
	...
	[HttpDelete("{clientId}")]
	public Task<bool> DeleteApplications(string clientId, [FromBody] List<long> applicationIds)
	{
		return _state.InvokeAsync<bool>(clientId, nameof(IMonitorClientHandler.DeleteApplications), applicationIds);
	}
}